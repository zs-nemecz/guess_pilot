...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Asus\\Documents\\pretest_fmri\\guess\\guess.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    if guess_cond == "Read":
        print("Skipping this trial because guess_cond != 'Guess'");
    ...
    for thisPractice_trial in practice_trials:
        ...
        cue_types[cue] = is_guess
        target_types[target] = is_guess
        thisExp.addData('trial_type', is_guess)
