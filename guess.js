...
function guess_conditionsLoopBegin(guess_conditionsLoopScheduler, snapshot) {
  return async function() {
    ...
    for (const thisGuess_condition of guess_conditions) {
...
function test_practice_trialsLoopBegin(test_practice_trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisTest_practice_trial of test_practice_trials) {
...
function semantic_mappingLoopBegin(semantic_mappingLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisSemantic_mapping of semantic_mapping) {
...
function load_guess_conditionsRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of load_guess_conditionsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function iti_learning_practiceRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of iti_learning_practiceComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function guessRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of guessComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function guess_responseRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of guess_responseComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function feedback_guessRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of feedback_guessComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function iti_learningRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of iti_learningComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function end_part1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of end_part1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function instructions_recall1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of instructions_recall1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function instructions_recall2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of instructions_recall2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function cued_recallRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of cued_recallComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function recall_responseRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of recall_responseComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function recall_selectRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of recall_selectComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function recall_feedbackRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of recall_feedbackComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function end_part2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of end_part2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function instructions_semantic_mapping1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of instructions_semantic_mapping1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function instructions_semantic_mapping2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of instructions_semantic_mapping2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function mapping_breakRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of mapping_breakComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
